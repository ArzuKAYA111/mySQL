...
import com.SQLhrms.testbase.PageInitializer;

// TO SEE ALL METHODS  CNTRL  +  O 
public class CommonMethods extends PageInitializer {

	/**
	 * 1- Method That clears and Send Keys to All Text Boxes
	 * 
	 * @param element
	 * @param text
	 */
	...
	/**
	 * 2- Method checks if radio/checkbox is enabled and click radio button or check
	 * boxes
	 * 
	...
	/**
	 * 3- This method gets the table row values
	 * 
	 * @param element
	 */
	...
	/**
	 * 4- this method gets the table colms values
	 * 
	 * @param element
	 */
	...
	/**
	 * 5- Method that check Drop Down if a specific text is there and then select it
	 * 
	 * @param element
	 * @param textToSelect
	 */
	...
	/**
	 * 6- Method that check Drop down if a specific index is there and then select
	 * it
	 * 
	 * @param element
	 * @param index
...
// HM try to create method ByValue
	/**
	 * 7- Method that check Drop down if a specific Value is there and then select
	 * it Select Drop Down By Value
	 * 
	 * @param element
	 * @param value
	 */
	public static void selectDdByValue(WebElement element, String value) {// bu methodu ben yaptim Select Drop Down By
																			// Value
	...
	/**
	 * 8- methods that accept alerts and catches exception if alert is not present
	 */
	...
	/**
	 * 9- methods that dismiss alerts and catches exception if alert is not present
	 * 
	 * @return
	 */
	...
	/**
	 * 10- methods that get text of alert and catches exception if alert is not
	 * present
	 * 
	 * @return
	 */
	...
	/**
	 * 11- methods that get text of alert and catches exception if alert is not
	 * present
	 * 
	 * @return
	 */
	...
	/**
	 * 12- method that is used to switch to Frame by name or id
	 * 
	 * @param nameOrid
	 */
	...
	/**
	 * 13- method that is used to switch to Frame by WebElement
	 * 
	 * @param nameOrid
	 */
	...
	/**
	 * 14- method that is used to switch to Frame by index
	 * 
	 * @param nameOrid
	 */
	...
	/**
	 * 15 Method switches focus to child window
	 */
	...
	/**
	 * 18- Wait for element to visibility
	 * 
	 * @param element
	 * @return
	 */
	...
	/**
	 * 23- Method that will scroll the page down based on the passed pixel
	 * parameters
	 * 
	 * @param pixel
	 */
	...
	/**
	 * 24- Method that will scroll the page up based on the passed pixel parameters
	 * 
	 * @param pixel
	 */
	...
	/**
	 * 25- This Method will take a screenshot
	 * 
	 * @param filename
	 */
	...
	/**
	 * 26- method wait for specific seconds
	 * 
	 * @param second
